        ...
        return httpSecurity.authorizeHttpRequests(
                        ...
                        authorizeRequests ->
                                authorizeRequests
                                        ...
                                        .requestMatchers("/","/about","/contact", "/register", "/login", "/car", "/login-error","/services", "/pricing", "/add-vehicle").permitAll()//Позволява избраните уеб страници да бъдат достъпни за всички.
